      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            @if(session()->get('language')=='hindi') मेरी प्रोफाइल
        ...
        <div class="cnt-block">
          <ul class="list-unstyled list-inline">
            ...
            <span class="value">
            @if(session()->get('language')=='hindi') भाषा: हिंदी 
             @else
                          ...
                          <h2 class="title">
                            ...
                            @endif  
                             ...
                             <ul class="link">
                              ...
                              @if(session()->get('language')=='hindi') {{$subsubcategory->subsubcategory_name_hi}} 
                                @else
