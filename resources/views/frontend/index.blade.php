                  ...
                  <li class="yamm-content">
                    ...
                    @php
                      ...
                      <div class="col-sm-12 col-md-3">
                          <h2 class="title">
                          @if(session()->get('language')=='hindi') {{$subcategory->subcategory_name_hi}} 
                              @else
            ...
            <div class="item">
              <div class="products">
                <div class="hot-deal-wrapper">
                  <div class="image"> <img src="{{asset($product->product_thumbnil)}}" alt=""> </div>
      ...
      <div class="row product-micro-row">
        <div class="col col-xs-5">
          <div class="product-image">
            <div class="image"> <a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}"> <img src="{{ asset($product->product_thumbnil) }}" alt=""> </a> </div>
            <!-- /.image --> 
                    ...
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          ...
                          @if(session()->get('language')=='hindi') {{$product->product_name_hi}} 
                            @else
              ...
              <div class="product-slider">
                ...
                @forelse($catwiseProduct as $product)
                  ...
                  <!-- /.item -->
                    ...
                    @endforelse
                    <!-- End all option product forelse -->
                </div>
                <!-- /.home-owl-carousel --> 
              </div>
              <!-- /.product-slider --> 
...
@if(session()->get('language') == 'hindi') {{ $skip_category_0->category_name_hi }} @else {{ $skip_category_0->category_name_en }} @endif
            </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
        ...
        <div class="product-info text-left">
          <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
@if(session()->get('language') == 'hindi') {{ $product->product_name_hi }} @else {{ $product->product_name_en }} @endif
            </a></h3>
          <div class="rating rateit-small"></div>
          <div class="description"></div>
 ...
 <div class="product-price"> <span class="price"> ${{ $product->discount_price }} </span> <span class="price-before-discount">$ {{ $product->selling_price }}</span> </div>
        ...
        <!-- ============================================== SKIP_PRODUCTS_0 : END ============================================== --> 
          ...
          <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
@if(session()->get('language') == 'hindi') {{ $skip_category_1->category_name_hi }} @else {{ $skip_category_1->category_name_en }} @endif
            </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
<section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
@if(session()->get('language') == 'hindi') {{ $skip_brand_1->brand_name_hi }} @else {{ $skip_brand_1->brand_name_en }} @endif
            </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
